...
1. [Add Product](/api-reference/product-v2/add-an-item) : Add new product entries to build and expand your product catalog.
    ...
    <Card
        ...
        icon="play"
        horizontal
        href="/api-reference/product-v2/add-an-item"
    >
        Try Adding an item
    </Card>

2. [Get Product](/api-reference/product-v2/get-item-details) : Access specific product information quickly for operational needs or customer queries.
    ...
    <Card
        ...
        icon="play"
        horizontal
        href="/api-reference/product-v2/get-item-details"
    >
        Try fetching item details
    </Card>
3. [Update Product](/api-reference/product-v2/update-an-item) : Modify existing product information to ensure accuracy and relevance, including name, description, pricing, and availability.
    ...
    <Card
        ...
        icon="play"
        horizontal
        href="/api-reference/product-v2/update-an-item"
    >
        Try Updating an item
    </Card>
4. [Delete Product](/api-reference/product-v2/delete-an-item) : Remove outdated or inactive products to maintain a streamlined and updated catalog.
    ...
    <Card
        ...
        icon="play"
        horizontal
        href="/api-reference/product-v2/delete-an-item"
    >
        Try Deleting an Item
    </Card>
5. [Products List](/api-reference/product-v2/get-list-of-items) : Retrieve a complete list of all products in your catalog, enabling efficient management and analysis.
    ...
    <Card
        ...
        icon="play"
        horizontal
        href="/api-reference/product-v2/get-list-of-items"
    >
        Fetch List of all items
    </Card>
6. [Update Product Mapping](/api-reference/product-v2/update-items-mapping) : Seamlessly update product ID mappings to ensure consistency and alignment across systems, avoiding duplicate records and streamlining integrations.
    ...
    <Card
        ...
        icon="play"
        horizontal
        href="/api-reference/product-v2/update-items-mapping"
    >
