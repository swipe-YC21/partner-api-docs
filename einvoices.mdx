...
1.  [E-Invoice Creation](/api-reference/document-v2/create-a-document): Easily generate e-invoices by passing `einvoice=1` in the document creation API request.
...
2.  [Fetch PDF](/api-reference/document-v2/get-document-pdf): Access PDFs of already created e-invoice documents.
