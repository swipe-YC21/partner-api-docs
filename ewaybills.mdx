...
1.  [EwayBill Creation](/api-reference/ewaybill/create-eway-bill): Easily generate professional invoices, pro forma invoices, sales returns, and purchase returns tailored to your business needs.
    ...
    <Card
        ...
        icon="play"
        horizontal
        href="/api-reference/ewaybill/create-eway-bill"
    >
        Try Creating an EwayBill
    </Card>

2.  [Fetch PDF](/api-reference/ewaybill/get-ewaybill-pdf): Access PDFs of already created ewaybills.
    ...
    <Card
        ...
        icon="play"
        horizontal
        href="/api-reference/ewaybill/get-ewaybill-pdf"
    >
