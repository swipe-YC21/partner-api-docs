...
1. [Record Payment](/api-reference/payment-v2/record-payment) : Record payments made by customers against their documents with accuracy and efficiency
    ...
    <Card
        ...
        icon="play"
        horizontal
        href="/api-reference/payment-v2/record-payment"
    >
        Try Recording a payment
    </Card>

2. [Fetch All Payments](/api-reference/payment-v2/list-of-payments) : Retrieve a complete list of all payments in your system based on the status enabling seamless tracking and management.
    ...
    <Card
        ...
        icon="play"
        horizontal
        href="/api-reference/payment-v2/list-of-payments"
    >
