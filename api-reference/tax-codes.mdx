---
title: Tax Codes (TDS & TCS)
icon: 'percent'
description: 'TDS and TCS code IDs to use in the tds_id and tcs_id fields when creating documents.'
---

Pass the **ID** from these tables as `tds_id` or `tcs_id` when [creating a document](/api-reference/document-v2/create-a-document). TDS and TCS cannot be applied together on the same document.
