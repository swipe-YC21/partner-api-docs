...
Swipe is a simple and powerful invoicing, payments, and GST platform trusted by 2 million+ businesses. Our RESTful API lets you integrate Swipe's invoicing capabilities into your applications, enabling automated workflows, real-time data sync, and secure transactions.
...
### 3. Test the API in Playground
    ...
    - Open our [API Playground](/api-reference/document-v2/create-a-document).
...
2. Open the API Playground by visiting [API Playground Link](/api-reference/document-v2/create-a-document).
